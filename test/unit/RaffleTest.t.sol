...
import {console} from "forge-std/console.sol"; // Uncomment if you want to use console.log for debugging
import {Vm} from "forge-std/Vm.sol"; // Import Vm for testing purposes
...
contract RaffleTest is Test, CodeConstants {
    ...
    function setUp() public {
        ...
        deal(config.link, config.account, 10 * 1e18);
        LinkToken linkToken = new LinkToken();
        linkToken.mint(config.account, 1000 * 1e18);
